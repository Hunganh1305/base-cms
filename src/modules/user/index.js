    ...
    const columns = [
        {
            ...
            align: 'center',
            width: 100,
            render: (avatar) => <AvatarField size="large" icon={<UserOutlined />} src={avatar ? avatar[0] : null} />,
        },
            ...
            render: (state) => {
                ...
                return (
                    <Tag color={kind?.color}>
                        <div style={{ padding: '0 4px', fontSize: 14, textTransform: 'capitalize' }}>{kind?.label}</div>
                    </Tag>
                );
            },
        },
